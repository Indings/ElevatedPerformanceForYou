...
<body>
    ...
    <div class="contentcontainer">
        Union Grove Teacher Workshop Video
        <div>
            <video class="sideVideo" controls>
                <source src="Images/UnionGroveTeacherWorkshopVideo.mp4" type="video/mp4">
            </video>
        </div>
        <br>
        Hole Lot of Trouble Activity
        <div>
            <video class="sideVideo" controls>
                <source src="Images/WIHoleLotofTrouble.mp4" type="video/mp4">
            </video>
        </div>
        <br>
        Stuck On You Activity
        <div>
            <video class="sideVideo" controls>
                <source src="Images/StuckOnYouActivityTriton.mp4" type="video/mp4">
            </video>
        </div>
