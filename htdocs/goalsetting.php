...
<head>
    ...
    <title>Goal Setting & Strategic Planning</title>
...
<body>
    ...
    <div class="darkbanner">
        <div class="leftHalf">Specific and appropriate strategic planning</div>
        <div class="rightHalf">
            <img class="bgimg" src="Images/MVI_4065_Moment.jpg" alt="background">
        </div>
    </div>
    <div class="lightbanner">
        <div class="leftHalf">
            <img class="bgimg" src="Images/cromwellboardgroupphoto3.jpg" alt="background">
        </div>
        <div class="rightHalf">Board goal setting</div>
    </div>
